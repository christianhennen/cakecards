        ...
        <div class="modal-content">
            ...
            <div class="modal-body row">
                ...
                <div class="col-sm-5" id="mediaGalleryNav">
                    <p><a href="#" id="fromFileSystem"><?php echo __('Choose from file system') ?></a></p>

                    <p><a href="#" id="fromGallery"><?php echo __('Choose from image gallery') ?></a></p>
                </div>
                <div class="col-sm-7" id="mediaGallery"></div>
                <div class="col-sm-7" id="mediaGalleryFilesystem" style="display: none">
                    <div class="row">
                        <form id="fileupload" action="<?php echo $this->webroot ?>uploads.json" method="POST"
                            ...
                            <div class="row fileupload-buttonbar">
                                <div class="col-xs-12">
                                    ...
                                    <span class="btn btn-primary startupload-button" style="display: none">
                                        ...
                                        <span><?php echo __('Upload %d files') ?></span>
                                    </span>
