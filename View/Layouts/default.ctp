...
<head>
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			<? echo "var ontext ='".__('Yes')."'; var offtext = '".__('No')."';" ?>
			$("#OptionEditForm :checkbox").bootstrapSwitch({onText:ontext,offText:offtext});
			$("#OptionAddForm :checkbox").bootstrapSwitch({onText:ontext,offText:offtext});
			$("#mailingOptionSwitches :checkbox").bootstrapSwitch({onText:ontext,offText:offtext});
		});
